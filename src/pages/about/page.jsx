...
const page = () => {
  return (
    <NetBandLayout>
      <Breadcrumb pageTitle={"about us1"} />
      {/*<< About Section Start >>*/}
      ...
      <section className="service-section-3 fix section-padding pt-0">
        <div className="container">
          <div className="section-title text-center">
            <span className=" ">our fucusable services</span>
        ...
        <div className="container">
          <div className="cta-parallax-wrapper text-center">
            ...
            <div className="button-items">
              ...
              <a href="tel:+91 9884098840" className="theme-btn bg-white">
                <span>
      ...
      <section className="news-section-2 section-padding fix">
        <div className="container">
          <div className="title-section-area">
            <div className="section-title">
              <span className=" ">5m+ Trusted Our Clients</span>
              <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
                Read Our News &amp; Blogs
              </h2>
