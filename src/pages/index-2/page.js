...
const page = () => {
      ...
      <section className="service-section-2 fix section-padding">
        <div className="container">
          <div className="section-title text-center">
            <span className=" ">Our Service Area</span>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="about-image-items">
                  ...
                  <div
                    className="about-image bg-cover  "
                    data-aos="fade-up" 
  data-aos-delay="3000"
                    style={{
              ...
              <div className="col-lg-6 mt-5 mt-lg-0">
                <div className="about-content">
                  <div className="section-title">
                    <span className=" ">About Our Internet</span>
                    <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
  ...
  data-aos-delay=".6s"
      ...
      <section className="service-section fix section-padding section-bg-2">
        ...
        <div className="container">
          <div className="section-title text-center">
            <span className=" ">Our awesom service</span>
            <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
  ...
  data-aos-delay="5000">
      ...
      <section className="team-section section-padding section-bg-3">
        <div className="container">
          <div className="section-title text-center">
            <span className=" ">our hounrable team</span>
            ...
            >
              <div className="single-team-items style-2">
                ...
                <div className="team-content text-center">
                  <h5>
                    <Link href="team-detaills">Dhanishta</Link>
                  </h5>
                  <p>Team Leader</p>
                </div>
              </div>
  ...
  data-aos-delay="5000"
            >
              <div className="single-team-items style-2">
                ...
                <div className="team-content text-center">
                  <h5>
                    <Link href="team-detaills">Daarun</Link>
                  </h5>
                  <p>Field ExecutiveER</p>
                </div>
              </div>
            </div>
            <div
  ...
  data-aos-delay=".9s"
          ...
          <div className="team-button  " data-aos="fade-up" 
  data-aos-delay=".4s">
      ...
      <section className="pricing-section-2 fix section-padding">
        <div className="container">
          <div className="section-title text-center mb-0">
            <span className=" ">OUR PRICING PLAN</span>
            <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
              Our Pricing Plan
            </h2>
          ...
          <div className="row pt-5">
            <div className="pricing-wrapper  " data-aos="fade-up" 
  data-aos-delay="3000">
            ...
            <div
              className="pricing-wrapper active  "
              data-aos="fade-up" 
  data-aos-delay="3000"
            >
              <div className="row justify-content-between align-items-center">
