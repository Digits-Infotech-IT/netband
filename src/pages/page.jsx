...
const page = () => {
              ...
              <div className="col-lg-6 mt-5 mt-lg-0">
                <div className="about-content">
                  <div className="section-title">
                    <span className=" ">About Netband</span>
        ...
        <div className="container custom-container-2">
          <div className="network-solution-wrapper">
            <div className="section-title text-center">
              <span className=" ">Best Network</span>
              <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
  ...
  data-aos-delay="7000"
      ...
      <section className="team-section section-padding">
        <div className="container">
          <div className="section-title text-center">
            <span className=" ">our members</span>
            <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
              ...
              >
                <div className="single-team-items">
                  ...
                  <div className="team-content text-center">
                    <h4>
                      <Link href="team-detaills">Kabilan</Link>
                    </h4>
  ...
  data-aos-delay="5000"
              >
                <div className="single-team-items">
                  ...
                  <div className="team-content text-center">
                    <h4>
                      <Link href="team-detaills">Ekaaksh</Link>
                    </h4>
                    <p>Team Leader</p>
                  </div>
                </div>
  ...
  data-aos-delay="5000"
              ...
              <a
                href="tel:+91 9884098840"
                className="theme-btn bg-white  "
                data-aos="fade-up" 
  data-aos-delay="7000"
              >
                <span>
                  +91 9884098840 <i className="fas fa-chevron-right" />
                </span>
              </a>
            </div>
          </div>
  ...
  data-aos-delay="8000">
      ...
      <section className="testimonial-section section-padding fix">
        <div className="container">
          <div className="section-title text-center">
            <span className=" ">trusted clients feedback</span>
            <h2 className=" " data-aos="fade-up" 
  data-aos-delay="3000">
