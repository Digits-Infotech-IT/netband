      ...
      <div className="swiper-wrapper">
        <SwiperSlide className="swiper-slide">
          <div className="movie-card-items">
            ...
            <div className="movie-content">
              <h3>
                <Link href="shows-details">Good Bad Ugly</Link>
              </h3>
        ...
        <SwiperSlide className="swiper-slide">
          <div className="movie-card-items">
            ...
            <div className="movie-content">
              <h3>
                <Link href="shows-details">Bigil</Link>
              </h3>
              <div className="movie-review">
                <span>(2024)</span>
                <ul>
        ...
        <SwiperSlide className="swiper-slide">
          <div className="movie-card-items">
            ...
            <div className="movie-content">
              <h3>
                <Link href="shows-details">War2</Link>
              </h3>
              <div className="movie-review">
                <span>(2024)</span>
                <ul>
        ...
        <SwiperSlide className="swiper-slide">
          <div className="movie-card-items">
            ...
            <div className="movie-content">
              <h3>
                <Link href="shows-details">SAIYAARA</Link>
              </h3>
              <div className="movie-review">
                <span>(2024)</span>
                <ul>
...
export const MovieSlider2 = () => {
  ...
  data-aos-delay="3000">
          ...
          <div
            className="array-button style-2  "
            data-aos="fade-up" 
  data-aos-delay="5000"
          >
            ...
            <SwiperSlide className="swiper-slide">
              <div className="shows-card-items">
                ...
                <div className="shows-content">
                  <div className="show-title">
                    <h4>
                      <Link href="shows-details">Terribile SAIYAARA</Link>
                    </h4>
                    <span>
                      9.2
                      <i className="fas fa-star" />
